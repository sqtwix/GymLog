...
dependencies {
    ...
    implementation("org.jetbrains.kotlinx:kotlinx-datetime:0.6.1") // или используй java.time напрямую
    ...
    implementation("com.squareup.okhttp3:okhttp:5.0.0-alpha.14")           // или 4.12.0, если alpha не нравится
